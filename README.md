...
脚本から盤面は一応完成
次は脚本作成時に駒を追加する際に拡張情報を代入する方法を座の隷下クラスで実装しようと思う
どういうことかというと、Za.xxxsみたいな形で拡張を検索する
検索時に何かヒットしたら、適当にその拡張を管理する振る舞いへ要請を投げる。なお、振る舞いは座を変更したくないからXxxモデルに抱えてもらう
こうする事で少なくとも座側は座がどんどん増えて脚本作成時の拡張情報がどんどん増えても変化せずにすみそう

脚本作成時の駒拡張情報を設定する為にJSが必要だけど既に肥大化してるのでWebPackerを試してみようと思う。参考サイトは以下
https://medium.com/@jiraffestaff/4616a24d1c39
